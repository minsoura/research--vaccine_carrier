...
import xyz.minsoura.vaccinator.recordPage.PersonTab;
import xyz.minsoura.vaccinator.recordPage.VaccineTab;
...
public class ViewPagerAdapter2 extends FragmentStatePagerAdapter {
   ...
   PersonTab personTab;
    ...
    public Fragment getItem(int position) {
        ...
        {
            personTab = new PersonTab();
            return personTab;
        }
        else if(position ==1)        // As we are having 2 tabs if the position is now 0 it must be 1 so we are returning second tab
        {
            vaccineTab = new VaccineTab();
            return vaccineTab;
        }
